...
export const workflowExecutionStatus = pgEnum("workflow_execution_status", ["PENDING", "RUNNING", "FAILED", "COMPLETED"]);
export const executionPhaseStatus = pgEnum("execution_phase_status", ["CREATED", "PENDING", "RUNNING", "FAILED", "COMPLETED"]);
