...
import ExecutionTable from "./[executionId]/_components/execution-table";
      ...
      <Suspense
        fallback={
          <div className="flex h-full w-full items-center justify-center">
            <Loader2Icon className="animate-spin stroke-primary" size={50} />
          </div>
        }
      >
...
async function ExecutionsTableWrapper({ workflowId }: { workflowId: string }) {
  ...
  if (!executions || error || executions.resolved === "error")
  ...
  return (
    <div className="container py-6">
      <ExecutionTable workflowId={workflowId} initData={executions} />
    </div>
  );
}
